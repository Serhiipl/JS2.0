...
let ar1 = ["Hello", 23, true, 41, "a"]; // переменную обьявляем здесь!!!!
...
let ar2 = ["Hello", 23, true, 41, "a"]; // переменную обьявляем здесь!!!!
...
let ar3 = ["Hello", "Amigo", 8, 37, 21]; // переменную обьявляем здесь!!!!
...
let ar4 = ["Hello", "Amigo", 8, 37, 21, true, 44, 58, 62, "I'm"]; // переменную обьявляем эту здесь!!!!
